...
*running* it; instead `tests/Run-Tests.ps1` (75 checks on stock Windows
...
Exit code `0` means all 75 checks passed; `1` means at least one failed, with
